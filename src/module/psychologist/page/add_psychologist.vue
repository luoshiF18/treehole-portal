<template>
  <div>
    <el-form :model="profileExtForm" :rules="profileExtFormRules" label-width="80px" ref="profileExtForm">
      ...
      <el-form-item label="擅长领域" prop="proficiency" style="width:30%">
        <el-input type="textarea"v-model="profileExtForm.proficiency" auto-complete="off" clearable></el-input>
      </el-form-item>
      <el-form-item label="工作室" prop="studio" style="width:30%">
      ...
      <el-form-item label="所持证书" prop="state.certificate" style="width:30%">
      ...
      <el-form-item label="详细地址" prop="state.address" style="width:30%">
      ...
      <el-form-item label="入住时间" prop="create_time">
        <el-date-picker type="datetime" placeholder="入住时间" v-model="profileExtForm.create_time"></el-date-picker>
      </el-form-item>
    </el-form>
    <div slot="footer" class="dialog-footer">
      <el-button type="success" @click="addSubmit">提交申请</el-button>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      //返回
      go_back: function () {
        this.$router.push({path: '/psychologist_list',})
      }
    },
  }
</script>
