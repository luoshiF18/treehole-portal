<template>
  <!--登录界面组件-->
  <div class="login_container" @keyup.enter="register1">
    <!--登录区域-->
    <div class="login_box">
      <el-form :model="registerForm" label-width="90px" class="login_form" :rules="registerRules" label="right" ref="registerForm" >
        <div class="content">
          <h2>用户注册</h2>
          <el-form-item label="昵称" prop="user_nickname">
            <el-input v-model="registerForm.user_nickname" placeholder="请输入昵称"  auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="手机号" prop="user_phone">
            <el-input v-model="registerForm.user_phone" placeholder="请输入手机号" auto-complete="off"></el-input>
          </el-form-item>
          <el-form-item label="密码" prop="password">
            <el-input v-model="registerForm.password" placeholder="请输入密码" auto-complete="off"></el-input>
          </el-form-item>
        </div>
...
<style scoped>
  .login_container {
    /*background-color: rgba(245, 165, 255, 0.12);*/
